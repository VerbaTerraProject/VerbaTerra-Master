...
class ICLHFModel:
    ...
    feature_cols: Sequence[str] = field(default_factory=lambda: ("ritual", "trade", "symbolism", "hierarchy"))
    ...
    def summary(self) -> str:
        ...
        def fmt(name: str, reg: LinearRegression) -> str:
            weights = ", ".join(f"{col}:{coef:.3f}" for col, coef in zip(self.feature_cols, reg.coef_))
